...
class CustomDialog {
  Future<dynamic> showWarningDialog(
      ...
      required String msg,
      String? btnMsg,
      required void Function() btnOnPress,
    ...
    return AwesomeDialog(
      ...
      // btnOkText: 'Ok',
      btnOkText: btnMsg ?? localization.text('ok'),
    ).show();
  }
  ...
  Future<dynamic> showOptionDialog({
    ...
    required void Function() okFun,
    required String cancelMsg,
    String? cancelnoLocalizationTxt,
    required void Function() cancelFun,
    num? width,
  }) {
    return AwesomeDialog(
      headerAnimationLoop: false,
      ...
      btnOkOnPress: okFun,
      btnOkText: localization.text(okMsg),
      // btnOkText: okMsg,
      btnCancelOnPress: cancelFun,
      btnCancelText: localization.text(cancelMsg),
