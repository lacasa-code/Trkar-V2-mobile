...
class _HomeScreenState extends State<HomeScreen>
  ...
  late MainCategoryWithChildrenCubit mainCategoryWithChildrenCubit;

  var isInit = true;
  @override
  void initState() {
    subCategoriesCubit = context.read<SubCategoriesCubit>();
    mainCategoryWithChildrenCubit = context
        .read<MainCategoryWithChildrenCubit>()
    ...
    _controller
        .addListener(() => mainCategoryWithChildrenCubit.onTabBarChanging(
              context: context,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MainCategoryWithChildrenCubit,
        MainCategoryWithChildrenState>(
      builder: (context, catState) {
        if (catState is MainCategoryWithChildrenLoading) {
                      ...
                      children: [
                        Container(
                          ...
                          child: TabBar(
                            ...
                            controller: _controller,
                            tabs: List.generate(
                              mainCategoryWithChildrenCubit
                                  .mainCategories.length,
                              (index) {
                                var e = mainCategoryWithChildrenCubit
                        ...
                        SizedBox(
                          height: mainCategoryWithChildrenCubit
                              .getTabBarSize(_controller.index),
                          child: TabBarView(
                            controller: _controller,
                            children: mainCategoryWithChildrenCubit
                                .mainCategories
                                .map(
                              (e) {
                                var subCategories =
                                    mainCategoryWithChildrenCubit
                                        .subCategoriesByCategoryId(e.id ?? 0);
                                return GridView(
